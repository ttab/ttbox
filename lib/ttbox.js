    ...
    jquery: function() {
      ...
      return {
        ...
        pillify: function(range, type, item, dispatch) {
          var $pill, $span, dfn, format, id, pill, remove, trig;
          trig = type.trig;
